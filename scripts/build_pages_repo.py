...
PATCHED_PACKAGES = [
    ...
    },
    {
        ...
        "source": PATCHED_DIR / "VBox_5.5「无根」_5.5-4_com.amg456.VBox1_nolicense_noheartbeat_nodelayedexit_dynamic100y_ustar.deb",
        "deb_name": "com.amg456.VBox1_5.5-4_nolicense_noheartbeat_nodelayedexit_dynamic100y_ustar.deb",
        "publish_name": "VBox_5.5「无根」 Patch NoLicense NoHeartbeat NoDelayedExit Dynamic 100Y USTAR",
        "publish_section": "VBox虚拟盒子",
        "publish_desc": "授权测试补丁包：禁用激活弹窗、周期心跳调度与回调，并移除授权失败后的 60 秒延迟退出；首页授权时间动态显示为设备当前时间加 100 年；使用无 PAX 扩展头的 USTAR deb 归档。",
