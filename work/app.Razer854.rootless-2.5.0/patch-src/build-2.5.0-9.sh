...
PKGROOT="$WORK/pkgroot-2.5.0-9"
REPACK="$WORK/repack-2.5.0-9"
VERIFY="$WORK/verify-final-2.5.0-9"
OUT="$ROOT/patched/2.5.0_Razer雷蛇(无根)_2.5.0-9_app.Razer854.rootless_authstate_ustar.deb"
HOOK_SRC="$WORK/patch-src/RazerAuth2099Hook.m"
HOOK="$WORK/patch-src/RazerAuth2099.dylib.v9"
...
sed -i '' 's/^Version: .*/Version: 2.5.0-9/' "$PKGROOT/DEBIAN/control"
